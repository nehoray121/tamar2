...
const UrgencyBreakdownCard = ({
    ...
    if (!isDonutExpanded) {
        ...
        const legendItems = priorityData
                    ...
                    <div className="tamar-v22-donut-legend">
                        ...
                        {legendItems.map((item) => (
                            <button
                                ...
                                className="tamar-v22-donut-legend-row text-right focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus)]"
                            >
