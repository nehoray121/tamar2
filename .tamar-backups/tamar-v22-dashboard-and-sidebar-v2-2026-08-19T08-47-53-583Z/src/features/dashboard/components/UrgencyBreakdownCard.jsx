...
const UrgencyBreakdownCard = ({
    ...
    if (!isDonutExpanded) {
        return (
            <DashboardCard className="tamar-reference-donut-card dashboard-card-motion flex h-full min-h-0 flex-col p-3" dir="rtl">
    ...
    return (
        <DashboardCard className="tamar-reference-donut-card dashboard-card-motion dashboard-expanded-card flex h-full min-h-0 flex-col p-3" dir="rtl">
            <div className="flex shrink-0 items-start justify-between gap-2">
                <div>
