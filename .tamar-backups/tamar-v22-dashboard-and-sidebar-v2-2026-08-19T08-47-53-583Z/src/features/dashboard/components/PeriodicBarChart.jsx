...
const PeriodicBarChart = ({ data, onBarClick, barsPerPage = 6, isExpanded = false, resetKey = '' }) => {
    ...
    return (
        <div className={`tamar-reference-bar-chart dashboard-chart-surface relative flex h-full min-h-0 ${chartPaddingClass} flex-col overflow-hidden rounded-b-[24px] bg-[var(--color-surface-raised)]`}>
