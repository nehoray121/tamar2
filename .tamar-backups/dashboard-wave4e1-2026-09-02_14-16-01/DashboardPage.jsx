...
const DashboardPage = () => {
    ...
    const renderExpanded = () => {
        if (expandedSection === 'barChart') return renderTrendCard();
        if (expandedSection === 'donut') return renderUrgencyCard();
        if (expandedSection === 'workload') return renderWorkloadCard();
        if (expandedSection === 'urgentQueue') return renderAttentionCard();
        return null;
    };
        ...
        <div dir="rtl" className="dashboard-page-v4b">
            ...
            <main className="dashboard-main-v4b">
                ...
                <div className="dashboard-stage-v4b">
                    {expandedSection ? (
                        <div className="dashboard-expanded-v4b">
                            {renderExpanded()}
                        </div>
                    ) : (
                        <div className="dashboard-grid-v4b">
                            <div className="dashboard-grid-v4b__cell">
                                {renderTrendCard()}
                            </div>
                            <div className="dashboard-grid-v4b__cell">
                                {renderUrgencyCard()}
