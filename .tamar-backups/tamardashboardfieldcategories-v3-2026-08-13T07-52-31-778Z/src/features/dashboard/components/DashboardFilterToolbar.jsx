        ...
        const DashboardFilterToolbar = ({ isExpanded, filters, setFilters, categoryOptions, sortOptions, onExport }) => (
            <div className={`grid transition-all duration-500 ${isExpanded ? 'mt-3 grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                <div className="min-h-0 overflow-hidden">
                    <div className="rounded-[24px] border border-[var(--color-border)] bg-[var(--color-surface-muted)] px-3 py-2.5 shadow-inner sm:px-4 sm:py-3">
                        <div className="mb-2 flex flex-wrap items-center gap-2">
                            <div className="flex items-center gap-2 rounded-2xl bg-[var(--color-surface-raised)] px-3 py-2 text-sm font-black text-[var(--color-text-primary)] shadow-sm ring-1 ring-[var(--color-border)]">
                        ...
                        <div className="flex flex-wrap items-center gap-2.5">
                            <div className="flex rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-1 shadow-sm">
