...
const DashboardPage = () => {
    ...
    return (
        <div dir="rtl" className={`tamar-v22-dashboard-page inquiry-page-surface flex h-full min-h-0 flex-col overflow-hidden shadow-none ${fullSectionExpansion ? 'lg:p-3' : ''}`}>
            ...
            <main className="tamar-v22-dashboard-main relative flex min-h-0 flex-1 flex-col overflow-hidden">
                ...
                <div className="min-h-0 flex-1 overflow-hidden">
                    {expandedSection === 'barChart' ? (
                        <div className="tamar-v22-expanded-panel grid h-full min-h-0 grid-cols-12">
                        ...
                        <div className="tamar-v22-expanded-panel tamar-v22-expanded-panel--donut grid h-full min-h-0 grid-cols-12">
                            <div className="col-span-12 min-h-0">
                        ...
                        <div dir="ltr" className="tamar-v22-dashboard-layout dashboard-motion grid h-full min-h-0 grid-cols-12">
                            ...
                            <div className={`dashboard-motion col-span-12 min-h-0 lg:col-start-1 ${expandedSection === 'workload' ? 'lg:col-span-4 lg:row-span-2 lg:row-start-1' : 'lg:col-span-4 lg:row-start-2'}`}>
                                <WorkloadPanel
                                    rows={workloadRows}
                            ...
                            <div className={`dashboard-motion col-span-12 min-h-0 lg:col-start-5 ${expandedSection === 'urgentQueue' ? 'lg:col-span-8 lg:row-span-2 lg:row-start-1' : 'lg:col-span-8 lg:row-start-2'}`}>
