...
const InquiryFormCanvas = ({
    ...
    const renderSection = ({ section, sectionIndex, items, collapsed }, connected = false) => (
        <section
            key={section.id}
            className={connected
                ? 'bg-[var(--color-surface-raised)]'
                : compact
                    ? 'overflow-hidden rounded-xl border border-[var(--color-border-strong)] bg-[var(--color-surface-raised)]'
        ...
        >
            {renderSectionHeader ? (
                renderSectionHeader({ section, sectionIndex, items })
            ) : (
                <header
                    className={compact
    ...
    return (
        <div
            ...
            data-connected-sections={connectedSections ? 'true' : 'false'}
            dir="rtl"
        >
            {connectedSections ? (
                <div
                    className="overflow-hidden rounded-xl border border-[var(--color-border-strong)] bg-[var(--color-surface-raised)] shadow-sm"
