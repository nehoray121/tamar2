...
const DashboardPage = () => {
    ...
    return (
        <div dir="rtl" className={`tamar-reference-dashboard-page inquiry-page-surface tamar-v22-dashboard-page wave-bg flex h-full min-h-0 flex-col overflow-hidden px-3 pb-3 pt-2 shadow-none ${fullSectionExpansion ? 'lg:p-3' : ''}`}>
            <DashboardHeader totalInquiries={totalInquiries} />

            <main className="tamar-v22-dashboard-main tamar-reference-dashboard-main flex min-h-0 flex-1 flex-col overflow-hidden">
                ...
                <div className="min-h-0 flex-1 overflow-hidden">
                    {expandedSection === 'barChart' ? (
                        ...
                        <div dir="ltr" className="tamar-v22-dashboard-layout tamar-reference-dashboard-layout dashboard-motion grid h-full min-h-0 grid-cols-12 grid-rows-[minmax(300px,400px)_minmax(158px,178px)] gap-2">
