...
const PeriodicTrendCard = ({
    ...
    return (
        <DashboardCard className={`tamar-v22-trend-card tamar-reference-trend-card dashboard-card-motion flex h-full min-h-0 flex-col ${isBarExpanded ? 'dashboard-expanded-card' : ''}`}>
