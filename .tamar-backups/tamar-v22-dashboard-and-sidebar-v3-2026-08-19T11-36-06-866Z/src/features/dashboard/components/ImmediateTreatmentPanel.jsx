...
const ImmediateTreatmentPanel = ({ items, expanded, onToggle, onInspect }) => {
    ...
    return (
        <DashboardCard className={`tamar-v22-attention-card tamar-reference-attention-card dashboard-card-motion flex h-full min-h-0 flex-col ${expanded ? 'dashboard-expanded-card' : ''}`} dir="rtl">
