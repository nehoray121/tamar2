...
const PeriodicBarChart = ({ data, onBarClick, barsPerPage = 6, isExpanded = false, resetKey = '' }) => {
    ...
    return (
        <div className={`tamar-reference-bar-chart tamar-v22-bar-chart dashboard-chart-surface relative flex h-full min-h-0 ${chartPaddingClass} flex-col overflow-hidden rounded-b-[24px] bg-[var(--color-surface-raised)]`}>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex min-h-0 h-full items-end justify-center">
                                                <span
                                                    className={`w-full ${isExpanded ? 'max-w-[58px]' : 'max-w-[50px]'} rounded-t-[18px] transition-all duration-300 group-hover:brightness-95 group-hover:drop-shadow-xl ${isHot ? 'bg-gradient-to-b from-pink-400 via-pink-300 to-pink-100/85' : 'bg-gradient-to-b from-blue-600 via-blue-400 to-blue-200/85'
                                                        }`}
