...
const WorkloadPanel = ({ rows, expanded, onToggle }) => {
    ...
    return (
        <DashboardCard className={`tamar-v22-workload-card tamar-reference-workload-card dashboard-card-motion flex h-full min-h-0 flex-col p-3 ${expanded ? 'dashboard-expanded-card' : ''}`} dir="rtl">
