...
import Icon from '../../../components/common/Icon.jsx';
        ...
        const DashboardSegmentedButton = ({ label, isActive, onClick }) => (
            <button
                type="button"
                onClick={onClick}
                className={`tamar-v22-segmented-button tamar-reference-segmented-button min-w-0 flex-1 rounded-xl px-2 py-2 text-sm font-black transition-all active:scale-95 ${
                    isActive
