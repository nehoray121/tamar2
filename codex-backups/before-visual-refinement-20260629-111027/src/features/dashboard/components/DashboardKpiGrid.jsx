...
const DashboardKpiGrid = ({ fullSectionExpansion, selectedKpis, onEdit, onRemove }) => (
    <div className={`dashboard-motion overflow-hidden ${fullSectionExpansion ? 'mb-0 max-h-0 -translate-y-2 opacity-0 pointer-events-none' : 'mb-3 max-h-[184px] translate-y-0 opacity-100 shrink-0'}`}>
        <div className="grid h-[clamp(172px,18vh,178px)] grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-6">
            ...
            {selectedKpis.length < 6 && (
                <button
                    ...
                    className="group flex h-[clamp(172px,18vh,178px)] min-h-[172px] flex-col items-center justify-center rounded-[24px] border-2 border-dashed border-blue-200 bg-[#F8FBFF]/90 text-blue-500 shadow-[0_12px_28px_rgba(59,130,246,0.06)] transition hover:-translate-y-0.5 hover:border-blue-300 hover:bg-[#F2F8FF] hover:shadow-[0_18px_34px_rgba(59,130,246,0.10)]"
                >
