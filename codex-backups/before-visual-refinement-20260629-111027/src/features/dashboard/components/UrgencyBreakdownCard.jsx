        ...
        return (
            <DashboardCard className="dashboard-card-motion flex h-full min-h-0 flex-col p-3" dir="rtl">
                ...
                <div className="flex min-h-0 flex-1 flex-col py-1">
                    <div className="flex min-h-[210px] flex-1 items-center justify-center">
                        <UrgencyDonutChart data={priorityData} onSegmentClick={handleDonutClick} />
                    </div>

                    <div className="mt-1 min-h-[44px] w-full shrink-0 rounded-2xl border border-slate-100 bg-slate-50/80 p-1.5">
                        <div className="flex items-start justify-center gap-1.5">
                            {visibleDonutCategories.map(item => (
                                <button key={item.label} type="button" title={item.label} onClick={() => handleDonutClick(item)} className="flex min-w-0 max-w-full items-center gap-1.5 rounded-xl bg-white px-2.5 py-1 text-xs font-black text-slate-700 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
    ...
    return (
        <DashboardCard className="dashboard-card-motion dashboard-expanded-card flex h-full min-h-0 flex-col p-4" dir="rtl">
            ...
            <div className="flex min-h-0 flex-1 flex-col gap-3 pt-3">
                <div className="grid shrink-0 gap-3 xl:grid-cols-[minmax(300px,0.85fr)_minmax(0,1.35fr)]">
                    <section className="flex min-h-[250px] flex-col rounded-[28px] border border-slate-200 bg-white px-4 py-3 shadow-sm">
                    ...
                    <section className="flex min-h-[250px] flex-col rounded-[28px] border border-slate-200 bg-white shadow-sm">
                        ...
                        <div className="flex min-h-0 flex-1 items-center px-3 py-3">
                            {donutCategories.length === 0 ? (
                                ...
                                <div className={`grid h-full w-full auto-rows-fr gap-2.5 ${categoryGridClass} ${categoryRowsClass}`}>
                                    {visibleDonutCategoryCards.map((category, index) => {
                                        ...
                                        return (
                                            <article
                                                ...
                                                className="flex min-h-0 cursor-pointer flex-col rounded-[22px] border border-slate-200 bg-white p-3 text-right shadow-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-md"
