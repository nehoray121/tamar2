...
const DashboardPage = () => {
    ...
    return (
        <div dir="rtl" className={`flex h-full min-h-0 flex-col overflow-hidden p-3 text-slate-800 wave-bg ${fullSectionExpansion ? 'lg:p-3' : ''}`}>
            ...
            <main className="flex min-h-0 flex-1 flex-col overflow-hidden">
                ...
                <div className="min-h-0 flex-1 overflow-hidden">
                    {expandedSection === 'barChart' ? (
                        ...
                        <div dir="ltr" className="dashboard-motion grid h-full min-h-0 grid-cols-12 grid-rows-[minmax(305px,1fr)_minmax(165px,190px)] gap-3">
