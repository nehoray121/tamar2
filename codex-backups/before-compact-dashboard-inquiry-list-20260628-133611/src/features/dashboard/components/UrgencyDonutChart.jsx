...
const UrgencyDonutChart = ({ data, onSegmentClick, isExpanded = false, hideCenter = false }) => {
    ...
    const chartSize = 204;
    const labelPadding = isExpanded ? 76 : 44;
    ...
    return (
        <div className="relative flex items-center justify-center p-2">
            <div className="pointer-events-none absolute h-48 w-48 rounded-full bg-gradient-to-b from-blue-50 to-white shadow-inner" style={{ transform: `translateY(${chartOffsetY}px)` }} />
            ...
            {!hideCenter && (
                <div className="donut-center absolute z-20 flex cursor-default flex-col items-center justify-center rounded-full bg-white/80 px-6 py-5 shadow-[0_18px_45px_rgba(37,99,235,0.12)] backdrop-blur-sm" style={{ transform: `translateY(${chartOffsetY}px)` }}>
