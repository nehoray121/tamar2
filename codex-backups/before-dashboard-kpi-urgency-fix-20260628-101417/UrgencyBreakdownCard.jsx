        ...
        <DashboardCard className="dashboard-card-motion dashboard-expanded-card flex h-full min-h-0 flex-col p-4" dir="rtl">
            ...
            <div className="flex min-h-0 flex-1 pt-3">
                <div className="relative h-full min-h-0 w-full overflow-hidden">
                    <div
                        className="grid h-full min-h-0 gap-4 overflow-hidden transition-[padding] duration-300 ease-in-out motion-reduce:transition-none"
                        style={{
                            gridTemplateColumns: 'minmax(360px,1.1fr) minmax(280px,0.72fr)',
                            paddingBottom: `${collapsedPanelHeight + 16}px`
                        }}
                    >
                        ...
                        <section className="flex h-full min-h-0 flex-col overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
                            <div className="flex min-h-0 flex-1 items-center justify-center p-4">
                                <div className="flex aspect-square w-full max-w-[340px] items-center justify-center">
                                    <UrgencyDonutChart data={priorityData} onSegmentClick={handleDonutClick} isExpanded hideCenter={showInlineDetails} />
                                </div>
                            </div>
                        </section>
                    </div>
                    ...
                    <section
                        className="absolute bottom-0 left-0 right-0 z-10 flex min-h-0 flex-col overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm transition-[height,box-shadow] duration-300 ease-in-out motion-reduce:transition-none"
                        style={{
                            height: showInlineDetails ? '100%' : `${collapsedPanelHeight}px`,
                            boxShadow: showInlineDetails ? '0 18px 36px rgba(15, 23, 42, 0.08)' : undefined
                        }}
                    >
                        <div className="flex shrink-0 items-center justify-between border-b border-slate-100 px-5 py-3.5">
