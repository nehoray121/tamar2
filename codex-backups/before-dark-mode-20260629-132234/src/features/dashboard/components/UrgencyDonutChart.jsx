...
const UrgencyDonutChart = ({ data, onSegmentClick, isExpanded = false, hideCenter = false }) => {
    ...
    return (
        <div className="relative flex items-center justify-center p-1.5">
            <div className={`pointer-events-none absolute rounded-full bg-gradient-to-b from-blue-50 to-white shadow-inner ${isExpanded ? 'h-44 w-44' : 'h-32 w-32'}`} style={{ transform: `translateY(${chartOffsetY}px)` }} />
