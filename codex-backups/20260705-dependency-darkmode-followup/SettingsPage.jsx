...
const DisplaySettings = ({ fields, tableFields, setTableFields, sections, setSections }) => {
    ...
    return (
        <div className="space-y-4">
            ...
            {mode === 'table' ? (
                <div className="mx-auto flex w-full max-w-[1380px] flex-col gap-8 py-4">
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="mx-auto flex min-h-[64px] w-full max-w-[1320px] items-center gap-4 rounded-xl border border-[#D7E7FF] bg-white py-3 pl-3 pr-6 shadow-sm">
                    ...
                    <div className="mx-auto w-full max-w-[1320px] rounded-3xl border border-[#D7E7FF] bg-white/60 p-6 shadow-sm">
                        <div className="grid items-start gap-4 min-[1280px]:grid-cols-5 md:grid-cols-3 sm:grid-cols-2">
                            {tableFields.map((id, index) => (
                                <div
                                    ...
                                    className="flex w-full min-w-0 flex-col rounded-2xl border border-[#D7E7FF] bg-white p-4 shadow-sm transition-all hover:border-[#93C5FD] hover:shadow-md"
                                >
                                    <div className="mb-4 flex items-center justify-between">
                            ...
                            {tableFields.length < 5 && (
                                <div className="flex w-full min-w-0 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[#BBD7FF] bg-[#F8FBFF] p-4 transition-colors hover:border-[#93C5FD]">
