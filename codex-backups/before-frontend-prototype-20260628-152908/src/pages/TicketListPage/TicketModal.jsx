...
const TicketModal = ({ ticket, viewType, transferContext = 'received', onClose }) => {
                        ...
                        {activeTab === 'info' && (
                            <div className="mx-auto max-w-[850px] space-y-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    {capabilities.canClose && <ModalActionButton icon="check" tone="success">סגירת פנייה</ModalActionButton>}
                                    {isEditing && (
                                        <>
