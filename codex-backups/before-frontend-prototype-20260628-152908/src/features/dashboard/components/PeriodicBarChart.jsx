...
import Icon from '../../../components/common/Icon.jsx';
        ...
        const PeriodicBarChart = ({ data, onBarClick, barsPerPage = 6, isExpanded = false }) => {
            ...
            const chartPaddingClass = isExpanded ? 'px-4 pb-3 pt-4 sm:px-5' : 'px-4 pb-2 pt-3';
            const plotPaddingClass = isExpanded ? 'px-4 pt-5 sm:px-6 lg:px-8' : 'px-6 pt-4';
            const plotMinHeightClass = 'min-h-0';
            const labelSlotClass = isExpanded ? 'min-h-[48px]' : 'min-h-[38px]';
            const labelGapClass = isExpanded ? 'pt-3' : 'pt-1.5';
