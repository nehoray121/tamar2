...
const PeriodicTrendCard = ({
    ...
    return (
        <DashboardCard className={`dashboard-card-motion flex h-full min-h-0 flex-col ${isBarExpanded ? 'dashboard-expanded-card' : ''}`}>
            <div className={`shrink-0 border-b border-slate-100 bg-white/90 ${isBarExpanded ? 'px-5 py-4' : 'px-4 py-2.5'}`}>
            ...
            <div className={`${isBarExpanded ? 'min-h-[220px]' : 'min-h-[180px]'} flex-1 overflow-hidden`}>
