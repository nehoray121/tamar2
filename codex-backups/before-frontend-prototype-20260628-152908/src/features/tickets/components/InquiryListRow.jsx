...
const InquiryListRow = ({ ticket, viewType, toggleState, onView }) => (
    <article className="group flex min-h-[58px] w-full min-w-0 flex-wrap items-center gap-x-4 gap-y-2 rounded-xl border border-[#C9E1FF] bg-white px-3 py-2.5 shadow-[0_5px_16px_rgba(37,99,235,0.09)] transition hover:-translate-y-0.5 hover:border-[#93C5FD] hover:bg-[#F8FBFF] hover:shadow-[0_10px_24px_rgba(37,99,235,0.14)]">
        ...
        <div className="grid min-w-[320px] flex-[1_1_520px] grid-cols-2 items-center gap-x-4 gap-y-2 lg:grid-cols-4">
