        ...
        <div className="grid h-[clamp(124px,13vh,132px)] grid-cols-1 gap-2.5 sm:grid-cols-2 xl:grid-cols-6">
            ...
            {selectedKpis.length < 6 && (
                <button
                    ...
                    className="group flex h-[clamp(124px,13vh,132px)] min-h-[124px] flex-col items-center justify-center rounded-[22px] border-2 border-dashed border-blue-200 bg-[#F8FBFF]/90 text-blue-500 shadow-[0_10px_22px_rgba(59,130,246,0.06)] transition hover:-translate-y-0.5 hover:border-blue-300 hover:bg-[#F2F8FF] hover:shadow-[0_16px_30px_rgba(59,130,246,0.10)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/40 dark:border-slate-600 dark:bg-slate-900/80 dark:text-blue-300 dark:shadow-[0_16px_34px_rgba(2,6,23,0.36)] dark:hover:border-slate-500 dark:hover:bg-slate-800/95 dark:focus-visible:ring-blue-300/40"
                >
                    <span className="flex h-7 w-7 items-center justify-center rounded-2xl border border-blue-100 bg-white shadow-sm transition group-hover:border-blue-200 group-hover:bg-blue-50 dark:border-slate-600 dark:bg-slate-800 dark:text-blue-300 dark:group-hover:border-slate-500 dark:group-hover:bg-slate-700">
