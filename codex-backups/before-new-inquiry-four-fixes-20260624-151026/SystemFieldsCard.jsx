        ...
        <div className="flex min-h-0 flex-1 flex-col gap-3 pt-3">
            ...
            <div className="relative flex min-h-0 flex-1 flex-col">
                <div className="mb-1 flex h-6 items-center justify-between">
                    <button type="button" onClick={() => setIsTemplateOpen((value) => !value)} className="inline-flex items-center gap-1 rounded-md bg-blue-50 px-2 py-1 text-[12px] font-black text-blue-700">
                ...
                {isTemplateOpen && (
                    <div className="absolute bottom-[calc(100%-28px)] right-0 z-30 max-h-40 w-[280px] overflow-y-auto rounded-xl border border-blue-100 bg-white p-2 text-right shadow-[0_16px_30px_rgba(15,23,42,0.14)]">
