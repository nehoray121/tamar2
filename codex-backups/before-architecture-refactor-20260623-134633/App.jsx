                ...
                <div className="relative flex items-center justify-center p-2">
                    ...
                    <svg width={size} height={size} className="relative z-10 overflow-visible drop-shadow-sm">
                        ...
                        {data.map(item => {
                            ...
                            const connectorStart = pointOnCircle(labelAngle, outerRingRadius + 5);
                            const connectorBend = pointOnCircle(labelAngle, outerRingRadius + 16);
                            const isRightSide = connectorBend.x >= center;
                            const connectorEndX = connectorBend.x + (isRightSide ? 18 : -18);
                            const labelPoint = {
                                x: connectorEndX + (isRightSide ? 6 : -6),
                                y: Math.min(size - 12, Math.max(12, connectorBend.y))
                            };
