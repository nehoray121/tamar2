...
const InquiryBulkActions = ({
    ...
    return (
        <>
            <div className="flex items-center gap-1.5 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-muted)]/55 p-1">
                <button
                ...
                >
                    <Icon
                        name={active ? 'check' : 'layers'}
                        className="h-3.5 w-3.5"
                    />
                    {active ? 'מצב בחירה' : 'בחירת פניות'}
                </button>
                ...
                {active && totalMatchingCount > 0 && (
                    ...
                    >
                        ...
                        {selectingAll
                            ? 'בוחר את כל הטבלה...'
                            : allMatchingSelected
                                ? `כל ${totalMatchingCount} בטבלה נבחרו`
                                : `בחר את כל ${totalMatchingCount} הפניות בטבלה`}
                    </button>
                )}
