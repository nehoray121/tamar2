...
import useIncidentDescriptionPaddingFix from '../../features/inquiries/hooks/useIncidentDescriptionPaddingFix.js';
...
function AppShell() {
    useIncidentDescriptionPaddingFix();
    ...
    return (
        <div
            className="inquiry-page-surface flex h-screen w-full overflow-hidden font-sans"
            dir="rtl"
        >
            {showEnvModal && (
                <EnvironmentSelectionModal
