const DEVELOPMENT_IDENTITIES = Object.freeze([
    ...
    Object.freeze({ key: 'requested-super-admin', personalNumber: '1234567', displayName: 'Development SUPER_ADMIN Local', email: 'super-admin-local@tamar.local.invalid', role: 'SUPER_ADMIN' }),
