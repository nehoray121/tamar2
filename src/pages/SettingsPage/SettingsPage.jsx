...
const compactFieldTemplates = [
    ...
    { type: 'date', name: 'תאריך', example: 'לדוגמה: תאריך יעד, תאריך ביקור...', icon: 'calendar' }
];
                ...
                <div className="space-y-4 p-4">
                    <div className="grid gap-2 md:grid-cols-2">
                        <ToggleSwitch
                            ...
                            description="מאפשר לבחור משתמשי חדר מתוך טאב שיוך המשתמשים בפנייה."
                        />
                        <ToggleSwitch
                            checked={Boolean(settings.automaticAssignmentEnabled)}
                            onChange={(value) => update('automaticAssignmentEnabled', value)}
                            label="שיוך אוטומטי"
                            description="כאשר פעיל, המערכת יכולה לשייך פנייה חדשה למשתמש זמין בחדר."
                        />
                    </div>
